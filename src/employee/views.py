...
def index(request):
    # to be edited later to fit the index html file for employe menu
    return HttpResponse("This will be main view for employee")
...
#         return JsonResponse("Department not added", safe=False)
...
#         return JsonResponse("Department not updated", safe=False)
...
def employeeApi(request, id=0):
    if request.method=='GET':
        ...
        return JsonResponse("employee not added", safe=False)
    elif request.method=='PUT':
        employee_data=JSONParser().parse(request)
        ...
        return JsonResponse("employee not updated", safe=False)
    elif request.method=='DELETE':
